/*! @azure/msal-node v2.4.0 2023-10-30 */
'use strict';
import { CacheManager, AccountEntity, CacheHelpers, AppMetadataEntity, ServerTelemetryEntity, AuthorityMetadataEntity, ThrottlingEntity } from '@azure/msal-common';
